...
public:
	...
	// Нарисовать прямоугольник (Старый вариант)
	void Rectangle(sf::RenderWindow* _rw, sf::Vector2f pos, sf::Vector2f size, sf::Color col);
	// Нарисовать прямоугольник с границей (Старый вариант)
	void Rectangle(sf::RenderWindow* _rw, sf::Vector2f pos, sf::Vector2f size, sf::Color col, sf::Color col2, float size2);
	...
	// Нарисовать спрайт
	void DrawSprite(sf::RenderWindow* _rw, sf::Sprite spr, sf::Vector2f pos, sf::Vector2f size);
	// Нарисовать спрайт с прозрачностью
	void DrawSprite(sf::RenderWindow* _rw, sf::Sprite spr, sf::Vector2f pos, sf::Vector2f size, int transparent);
	// Написать текст
